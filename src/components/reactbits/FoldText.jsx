...
/**
 * FoldText (react-bits, вариант JS + CSS), добавлен 06.08.2026 по прямому
 * запросу владельца — заголовок «Что перестанет теряться в вашем бизнесе»
 * в Agents.jsx. Без изменений в логике анимации относительно исходника:
 * prefers-reduced-motion уже встроен в компонент (сокращённая длительность,
 * без 3D-поворота), деградация по построению — трогать не нужно.
 */
const FoldText = ({
  text = 'Design unfolds',
  splitBy = 'char',
