 ...
 *  «Разбор бизнеса за 9 900 ₸» рвётся на «за 9 / 900 ₸» — цена в заголовке
...
export default function Audit() {
  return (
    /* tight: «Ворота → Разбор → Отчёт» — один аргумент, а не три отдельных
    ...
    <Section id="audit" className="bg-ink-2" tight>
      ...
      {/* «Разбор — законченный продукт» поднят в начало блока. Это ответ на
      ...
      <div className="mt-stack grid gap-10 lg:grid-cols-[1fr_1.05fr] lg:gap-14">
        {/* Что смотрим */}
        <Reveal>
          <ColumnTitle n="01">12 направлений разбора</ColumnTitle>
