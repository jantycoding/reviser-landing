---
name: ux-psychology
description: Advisory layer surfacing behavioral psychology principles (65 principles across 11 categories — attention, gestalt, memory, decision-making, cognitive biases, persuasion, emotion, ethics) for reviewing or designing landing pages, pricing pages, onboarding, checkout, and dashboards. Use when the user wants to apply psychology, mental models, or persuasion principles to a page design, wants to know why a page isn't converting from a behavioral-design angle, or wants an ethical (non-dark-pattern) review of persuasive UI. Weighted input — informs decisions, does not override brand identity or accessibility.
---
